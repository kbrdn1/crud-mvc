...
<body class="bg-dark d-flex justify-content-center">
    <div class="col-6 text-center">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="border-bottom border-2 border-end-0 border-start-0"><a href="index.php?action=delete&amp;id=<?= $produit['id'] ?>"><button class="btn-danger rounded-pill">delete</button></a></td>
                    </tr>
                <?php
                }
                ?>
        ...
        <a href="index.php?action=add"><button class="col-3 btn-success rounded-pill mt-3">Ajouter</button></a>
    </div>
